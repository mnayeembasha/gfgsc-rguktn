...
const DSASheet = () => {
  ...
  return (
    <>
      ...
      <section
        id="faq-section"
        className="bg-primary-light dark:bg-primary-dark  p-3 md-p-6 min-h-screen flex-grow"
      >
        <div data-aos="fade-up" className="container px-2 md:px-4 mx-auto">
          <h1 className="text-3xl font-bold md:text-4xl my-6 text-center text-heading-green dark-green-grad">
            DSA Sheet
          </h1>
            ...
            {Object.keys(dsaSheet).map((category, index) => (
              ...
              >
                ...
                <div
                  ...
                  className={`px-1 md:px-8 py-2 md:py-4 pb-4 md:pb-8 ${
                    ...
                    <table className="min-w-full text-sm text-left text-gray-500 dark:text-gray-400">
                      <thead className="text-xs uppercase bg-green-200 dark:bg-black dark:text-gray-400">
                        <tr>
                          <th
                            scope="col"
                            className="px-6 py-4 md:py-5 border-b dark:border-gray-600 text-green-900 dark:text-gray-100"
                          >
                            Question
                          </th>
                          <th
