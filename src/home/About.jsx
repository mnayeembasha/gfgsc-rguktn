const About = () => {
    ...
    <section id="about" className="py-9 md:py-18  dark:bg-[#252525] about-bg">
      <div
        data-aos="fade-up"
         data-aos-duration="2500"
        className="container mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 px-4 md:px-6  justify-center items-center"
      >
        <div
          data-aos="fade-up"
        ...
        <div data-aos="fade-up" className="md:col-span-7 space-y-4">
          <h2 className="text-3xl font-bold md:text-4xl text-heading-green dark-green-grad">About Us</h2>
