...
const Resources = () => {
  return (
    <>
      <Navbar />
      <section id="resources" className="min-h-screen primary py-4 md:pt-6 pb-8">
      ...
      {resources.map((resource) => (
        <div data-aos="fade-up" key={resource.id} className="rounded-lg bg-[#f0f8f0] bg-green-100 md:bg-green-200 p-4 shadow-md dark:bg-[#252525]">
